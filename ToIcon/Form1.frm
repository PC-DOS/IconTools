...
Dim lngCur As Long
strCur = InputBox$("請輸入您要跳轉的位置" & vbCrLf & "有效範圍:" & vbCrLf & "0~" & Label4.Caption - 1, "Jump")
If Trim(strCur) = "" Then
Exit Sub
End If
lngCur = Val(strCur)
...
.Caption = cur
End With
MsgBox "請輸入有效指針序號", vbExclamation, "Error"
With Me.Label5
.Enabled = True
.Alignment = 2
.Caption = cur
...
On Error Resume Next
Dim ans As Integer
ans = MsgBox("確定關閉當前打開的Win32PE文件?", vbQuestion + vbYesNo, "Ask")
If ans = vbYes Then
cod = True
With Me
.Tag = ""
...
End With
MsgBox "已經將圖標發送到剪貼板!", vbExclamation, "Info"
With Me.StateBar1
.Alignment = 0
.Caption = "圖標複製成功..."
End With
...
Exit Sub
ep:
MsgBox "複製圖片失敗，錯誤" & Err.Number & vbCrLf & Err.Description, vbCritical, "Error"
With Me.StateBar1
.Alignment = 0
.Caption = "圖標複製失敗..."
End With
...
Dim strCur As String
Dim lngCur As Long
strCur = InputBox$("請輸入您要跳轉到的位置" & vbCrLf & "有效範圍:" & vbCrLf & "0~" & Label4.Caption - 1, "Jump")
If Trim(strCur) = "" Then
Exit Sub
End If
lngCur = Val(strCur)
...
.Caption = cur
End With
MsgBox "請輸入有效的圖標指針序號", vbExclamation, "Error"
With Me.Label5
.Enabled = True
.Alignment = 2
.Caption = cur
...
.SetData Me.Picture3.Image
End With
MsgBox "已將圖標發送到剪貼板!", vbExclamation, "Info"
With Me.StateBar1
.Alignment = 0
.Caption = "圖標複製成功..."
End With
...
Exit Sub
ep:
MsgBox "複製圖片失敗" & Err.Number & vbCrLf & Err.Description, vbCritical, "Error"
With Me.StateBar1
.Alignment = 0
.Caption = "圖標複製失敗..."
End With
...
Label4.Caption = tmp
Else
MsgBox "提取圖標失敗!", vbCritical, "Error"
Me.Command2.Enabled = False
Me.Command6.Enabled = False
Me.Command7.Enabled = False
Me.mnuSave.Enabled = False
...
End If
Else
MsgBox "圖標提取失敗!", vbCritical, "Error"
Me.Command2.Enabled = False
Me.Command6.Enabled = False
Me.Command7.Enabled = False
With Me.StateBar1
