...
End If
If Dir(pth) = "" Then
MsgBox "Windows找不到文件 " & pth & " 請確定文件是否存在，如果您想親自查找，請使用Windows搜索", vbExclamation, "Error"
Me.Dir1.Enabled = True
Me.File1.Enabled = True
Me.Text1.Enabled = True
Me.Command1.Enabled = True
...
If tmp = 0 Then
MsgBox pth & "不包含圖標，請選擇含有圖標的文件", vbExclamation, "Error"
Me.Dir1.Enabled = True
Me.File1.Enabled = True
Me.Text1.Enabled = True
Me.Command1.Enabled = True
...
End If
Else
MsgBox "您沒有選擇有效文件!", vbCritical, "Error"
Me.Dir1.Enabled = True
Me.File1.Enabled = True
Me.Text1.Enabled = True
Me.Command1.Enabled = True
...
tmp = ExtractIcon(App.hInstance, pth, -1)
If tmp = 0 Then
MsgBox pth & "不包含圖標，請選擇一個包含圖標的文件", vbExclamation, "Error"
Me.Dir1.Enabled = True
Me.File1.Enabled = True
Me.Text1.Enabled = True
Me.Command1.Enabled = True
